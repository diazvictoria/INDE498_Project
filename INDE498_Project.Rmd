...
The Seattle housing market is one of the hottest housing markets in the United States. The median house price for houses sold in Seattle has been steadily increasing over the years. From data obtained from Trulia, the Median Housing price increased from \$450,000 (September 2014) to $660,000 (August 2017) [@trulia]. Our project was motivated by how competitve the Seattle housing market is and we want to get a better understanding of how the characteristics of properties affect the price. To accomplish this goal, we chose to analyze data obtained for properties sold in Ames, Iowa. 
