...
corrplot(cor(train.prepost[, which(names(train.precrash) %in% c("YearBuilt", "YearRemodAdd", "MasVnrArea", "BsmtFinSF1", "BsmtFinDF2", "BsmtUnfSF", "TotalBsmtSF", "vX1stFlrSF", "X2ndFlrSF", "LowQualFinSF", "GrLivArea", "BsmtFullBath", "BsmtHalfBath", "FullBath", "HalfBath", "BedroomAbvGr", "KitchenAbvGr", "TotRmsAbvGrd", "Fireplaces", "GarageYrBlt", "GarageCars", "GarageArea", "WoodDeckSF", "OpenPorchSF", "EnclosedPorch", "X3SsnPorch", "ScreenPorch", "MiscVal", "MoSold" ))]), type = "upper")
...
# TotalBsmtSF with BsmtFinSF1 ############# THESE SHOULDN'T BE HERE
# TotalBsmtSF with BsmtFinSF2############# THESE SHOULDN'T BE HERE
# TotalBsmtSF with BsmtUnfSF############# THESE SHOULDN'T BE HERE
# GrLivArea  with X1stFlrSF ############# THESE SHOULDN'T BE HERE
# GrLivArea  with X2ndFlrSF ############# THESE SHOULDN'T BE HERE
# GrLivArea  with LowQualFinSF ############# THESE SHOULDN'T BE HERE
...
# We view the summary of our data and delete the appropriate predictors: RoofMatl, CentralAir, GarageQual, GarageCond
summary(train.postcrash)
train.postcrash <- train.postcrash %>% dplyr::select(- RoofMatl, - CentralAir, - GarageQual, - GarageCond)

# we apply linear regression again
lm.total.post <- lm(log(SalePrice)~., data=train.postcrash)

## ^ CURRENTLY GIVES ME AN ERROR -- I will look into this later
